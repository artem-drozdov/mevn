        ...
        <g>
            <g>
                <g>
                    <path
                        class="circle"
                        d="M154.848,6.347c-30.18,0-59.013,9.345-83.385,27.026c-4.19,3.04-5.329,8.795-2.613,13.202l22.33,36.228
				...
				c67.47,0,122.362,54.892,122.362,122.362C277.21,215.969,222.318,270.861,154.848,270.861z"
                    ...
                    <path
                        class="arrow"
                        d="M94.81,202.148c1.722-3.218,1.534-7.122-0.491-10.158l-11.513-17.27h84.913c14.459,0,26.222-11.763,26.222-26.222
...
.icon-logout {
    ...
    &.active-animate {
        .arrow {
            animation: arrow-animate infinite linear 1s;
            z-index: 10;
